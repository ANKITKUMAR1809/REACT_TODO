  ...
  return (
    <div className='h-screen w-screen flex flex-col justify-center items-center bg-zinc-50'>
      <div className='mt-8 md:w-2/5 w-[90%] shadow-2xl bg-white  px-8 py-8 rounded-2xl overflow-hidden'>
        ...
        <div>
          <button className='hover:scale-102 transition-all active:scale-97 w-full bg-zinc-400 py-2 rounded-2xl text-white text-2xl' onClick={handleOnclick}>Add Todo</button>
        </div>
        <div className='mt-12'>
